    ...
    return (
        <div className="w-screen h-screen bg-blue-300 flex justify-center items-center flex-col">
            <div className="w-[1485px] h-[700px] bg-neutral-100 flex flex-col items-center rounded-md shadow-lg">
                <div className="w-[1300px] h-[60px] m-auto bg-red-200 flex justify-end items-center p-2">
                    <button
                    className="w-[100px] h-[50px] bg-purple-400 rounded-md font-bold text-sm">
                    minhas aulas</button>
                </div>
                <div className="bg-green-200 m-auto w-[1300px] h-[640px] p-4 flex flex-row gap-4 flex-wrap">
                    <Service />
                    <Service />
                    <Service />
                    <Service />
